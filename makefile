...
linux-debug32: gmake-linux
	make -R -C ../.build/linux/gcc/projects/rqt config=debug32
linux-release32: gmake-linux
	make -R -C ../.build/linux/gcc/projects/rqt config=release32
linux-debug64: gmake-linux
	make -R -C ../.build/linux/gcc/projects/rqt config=debug64
linux-release64: gmake-linux
	make -R -C ../.build/linux/gcc/projects/rqt config=release64
linux: linux-debug32 linux-release32 linux-debug64 linux-release64

gmake-mingw-gcc:
	$(GENIE) --file=genie/genie.lua --gcc=mingw-gcc gmake
mingw-gcc-debug32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/projects/rqt config=debug32
mingw-gcc-release32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/projects/rqt config=release32
mingw-gcc-debug64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/projects/rqt config=debug64
mingw-gcc-release64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/projects/rqt config=release64
...
mingw-clang-debug32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/projects/rqt config=debug32
mingw-clang-release32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/projects/rqt config=release32
mingw-clang-debug64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/projects/rqt config=debug64
mingw-clang-release64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/projects/rqt config=release64
