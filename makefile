...
#	make -R -C ../.build/linux/gcc/rqt/projects config=debug32
#linux-release32: gmake-linux
#	make -R -C ../.build/linux/gcc/rqt/projects config=release32
linux-debug64: gmake-linux
	make -R -C ../.build/linux/gcc/rqt/projects config=debug64
linux-release64: gmake-linux
	make -R -C ../.build/linux/gcc/rqt/projects config=release64
linux: linux-debug64 linux-release64

gmake-mingw-gcc:
	$(GENIE) --file=genie/genie.lua --gcc=mingw-gcc gmake
#mingw-gcc-debug32: gmake-mingw-gcc
#	make -R -C ../.build/windows/mingw-gcc/rqt/projects config=debug32
#mingw-gcc-release32: gmake-mingw-gcc
#	make -R -C ../.build/windows/mingw-gcc/rqt/projects config=release32
mingw-gcc-debug64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rqt/projects config=debug64
mingw-gcc-release64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rqt/projects config=release64
...
#	make -R -C ../.build/windows/mingw-clang/rqt/projects config=debug32
#mingw-clang-release32: gmake-mingw-clang
#	make -R -C ../.build/windows/mingw-clang/rqt/projects config=release32
mingw-clang-debug64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rqt/projects config=debug64
mingw-clang-release64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rqt/projects config=release64
...
../.build/osx/gcc/rqt/projects:
	$(GENIE) --file=genie/genie.lua --gcc=osx gmake
osx-debug64: ../.build/osx/gcc/rqt/projects
	make -C ../.build/osx/gcc/rqt/projects config=debug64
osx-release64: ../.build/osx/gcc/rqt/projects
	make -C ../.build/osx/gcc/rqt/projects config=release64
